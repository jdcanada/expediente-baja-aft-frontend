...
export interface InformeResumenEnriquecido {
  ...
  autorizado_por: { id_persona: number; nombre: string; apellidos: string } | null;
  aprobado_por: { id_persona: number; nombre: string; apellidos: string } | null;
  es_autorizado_por: boolean;
  es_aprobado_por: boolean;
}
